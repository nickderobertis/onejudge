...
- *(deps)* relink oneharness-core for the server-overloaded fallback ([#94](https://github.com/nickderobertis/onejudge/pull/94))
...
- *(note)* take the note contract and its inbox from onemessagebus, and register the frame protocol as schemas ([#88](https://github.com/nickderobertis/onejudge/pull/88))

## [0.11.0](https://github.com/nickderobertis/onejudge/compare/v0.10.0...v0.11.0) - 2026-09-13

### Added

- *(evidence)* name the artifacts a judge reads directly, gitignored ones included ([#86](https://github.com/nickderobertis/onejudge/pull/86))
...
- *(judge)* [**breaking**] stack several judges on one worker, each run in parallel and answered together ([#80](https://github.com/nickderobertis/onejudge/pull/80))

## [0.8.1](https://github.com/nickderobertis/onejudge/compare/v0.8.0...v0.8.1) - 2026-09-11

### Fixed

- *(deps)* link the oneharness-core that runs a controlled codex turn under its own model, and classify its refusal ([#76](https://github.com/nickderobertis/onejudge/pull/76))
...
- deliver a role-addressed note to both parties of a conversation ([#71](https://github.com/nickderobertis/onejudge/pull/71))

## [0.6.2](https://github.com/nickderobertis/onejudge/compare/v0.6.1...v0.6.2) - 2026-08-29

### Other

- *(release)* declare release targets in the canonical release-targets.toml ([#69](https://github.com/nickderobertis/onejudge/pull/69))
...
## [0.5.3](https://github.com/nickderobertis/onejudge/compare/v0.5.2...v0.5.3) - 2026-08-25

### Fixed

- link the current oneharness-core so a session and control fix reaches a judged turn ([#61](https://github.com/nickderobertis/onejudge/pull/61))
